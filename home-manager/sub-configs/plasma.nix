...
{ config, lib, pkgs, plasma-manager, ... }:
{
  programs.plasma = {
    ...
    files = {
      ...
      "baloofilerc"."General"."exclude folders[$e]" = "$HOME/code/,$HOME/result/,$HOME/tmp/,/home/kt/";
      "baloofilerc"."General"."exclude folders\x5b$e\x5d" = "$HOME/code/,$HOME/result/,$HOME/tmp/";
      "baloofilerc"."General"."folders[$e]" = "$HOME/";
      "baloofilerc"."General"."folders\x5b$e\x5d" = "$HOME/";
      ...
      "dolphinrc"."Open-with settings"."History" = "code";
      "kactivitymanagerdrc"."activities"."851fa1c9-2c17-4808-bbb2-4ae1dafea8a5" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "851fa1c9-2c17-4808-bbb2-4ae1dafea8a5";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{e4cc6b31-957e-4e71-a109-b67a5571f9c8}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{7b30280d-35ef-4973-b35f-398d7de86fea}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{59aedd0b-ae1e-4d37-9471-e01caac8a541}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{68c062d4-7155-4683-a9b7-e3a4db159b16}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{e502e859-dbff-4873-92ac-cbea127a1281}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{6d7a6ef4-dcef-423b-aa19-56933e419c18}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{48570aa2-180f-4ab0-b22c-cecc1a3fcbd4}";
      ...
      "kwinrc"."Desktops"."Id_1" = "d90dc964-33dc-4d8b-81d9-c3b415496deb";
      ...
      "kxkbrc"."Layout"."Options" = "terminate:ctrl_alt_bksp,compose:rctrl";
